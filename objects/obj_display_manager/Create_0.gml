...
if (os_type == os_windows) {
    // Simulando a proporção (2400 x 1080)
    // Vamos reduzir a escala para caber no monitor do PC, mantendo a proporção
    var sim_scale = 0.5; // 50% do tamanho real para não explodir o monitor
